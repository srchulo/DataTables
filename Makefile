...
PARENT_NAME = 
DLBASE = $(BASEEXT)
VERSION_FROM = lib/DataTables.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/DataTables.pm

PM_TO_BLIB = lib/DataTables.pm \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  Data::Compare: '\''1.23'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: DataTables' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  CGI::Simple: '\''1.113'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "DataTables",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Data::Compare" : "1.23",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "CGI::Simple" : "1.113",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="CGI::Simple" VERSION="1.113" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/DataTables.pm blib/lib/DataTables.pm 
